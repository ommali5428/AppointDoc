...
$("#doctorlist").html(data);
	...
	$query1="select FullName from tbldoctor where ID = $drid ";
	...
	while($row1 = mysqli_fetch_array($result1))
				...
				<p>Book Appointment for <span style="font-weight: bold;" ><?php echo $row1['FullName']; }?></span>&nbsp; (<span style="font-weight: bold;" >
				
				
				
				<?php 
				
			$query2="select * from tblspecialization where ID = $spid ";
