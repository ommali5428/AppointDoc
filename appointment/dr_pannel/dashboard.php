...
?>
						<div class="pull-left">
							<h3 class="widget-title text-warning"><span class="counter" data-plugin="counterUp" style="color: #BBDEFB;"><?php echo htmlentities($totnewapt);?></span></h3>
							<small class="text-color">Total New Appointment</small>
						</div>
						
					</div>
					<footer class="widget-footer bg-warning" style="background-color: #BBDEFB;">
...
?>
						<div class="pull-left">
							<h3 class="widget-title text-success"><span class="counter" data-plugin="counterUp" style="color: #4FC3F7;"><?php echo htmlentities($totappapt);?></span></h3>
							<small class="text-color">Total Approved</small>
						</div>
					</div>
					<footer class="widget-footer bg-success" style="background-color: #4FC3F7;">
...
?>
							<h3 class="widget-title text-danger" ><span class="counter" data-plugin="counterUp" style="color:  #EF9A9A;"><?php echo htmlentities($totncanapt);?></span></h3>
							<small class="text-color">Cancelled Appointment</small>
						</div>
						
					</div>
					<footer class="widget-footer bg-danger" style="background-color: #EF9A9A;">
...
?>
							<h3 class="widget-title text-primary"><span class="counter" data-plugin="counterUp" style="color: #1565C0;"><?php echo htmlentities($totapt);?></span></h3>
							<small class="text-color">Total Appointment</small>
						</div>
						
					</div>
					<footer class="widget-footer bg-primary" style="background-color: #1565C0;">
